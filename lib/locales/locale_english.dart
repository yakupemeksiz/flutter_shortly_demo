...
final Map<String, String> _en = {
  ...
  localization.welcomeViewDescription:
      '''Build your brand's recognition and get detailed insights on how your links are performing''',
  localization.start: 'Start',
  localization.brandRecognitionTitle: 'Brand Recognition',
  localization.brandRecognitionDescription:
      '''Bos your brand recognition with each click. Generic links don't mean a thing. Branded links help instil confidence in your content.''',
  localization.detailedRecortTitle: 'Detail Records',
  localization.detailedRecortDescription:
      'Gain insights into who is clicking your links. Knowing when and where people engage with your content helps inform better decisions.',
  localization.fullyCustomizableTitle: 'Fully Customizable',
  localization.fullyCustomizableDescription:
      'Improve brand awareness and content discoverability through customizable links, supercharging audience engagement',
  localization.skip: 'Skip',
  localization.letsGetStartedTitle: ''' Let's get started!''',
  localization.letsGetStartedDescription:
